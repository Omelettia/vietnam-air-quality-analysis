...
\usepackage[backend=biber,style=authoryear]{biblatex}  % biber backend + author-year style
...
\graphicspath{{Hinh_ve/}{figures/}{../figures/}} % Thư mục chứa các hình ảnh
...
\nocite{*}   % ensure every reference in the .bib is printed
\printbibliography
...
\chapter{DỮ LIỆU VÀ ĐẶC TRƯNG}
\subfile{Chuong/Phu_luc_A}

\newpage
\chapter{CẤU HÌNH THÍ NGHIỆM}
