...
Chương 4 đã giải thích những gì mô hình học và vì sao nó hành xử như vậy: nội suy không gian từ các trạm lân cận mặt đất chi phối sức dự đoán của nó, vệ tinh thay thế một phần cho tín hiệu đó, các sản phẩm mô hình vận chuyển hóa học thất bại theo ba phương diện riêng biệt, và mật độ trạm --- được biểu đạt như sự gần kề với trạm neo gần nhất --- là ràng buộc then chốt.\footnote{\textbf{Lưu ý phiên bản (chưa định cuối):} các con số định lượng trong chương này hiện phản ánh cấu hình XGBoost-DART trước đây. Cấu hình định cuối của luận văn thống nhất dùng mô hình \emph{không-DART} (gbtree/HGB) trên bộ dữ liệu \texttt{unified\_thesis\_v4} --- giữ toàn bộ 40 trạm, trong đó 3 cảm biến từng bị loại được làm sạch theo hàng bởi mặt nạ QC mạnh hơn thay vì loại bỏ. Các kết quả đang được tính lại theo cấu hình này và sẽ thay thế các con số dưới đây; do đó các con số hiện tại chưa phải là kết quả định cuối.} Chương này trình bày đánh giá định lượng đầy đủ, xuất phát từ kỳ vọng ban đầu (nội suy thời gian) và đi sâu vào bài toán trọng tâm (ngoại suy không gian) như đã phân biệt ở Mục 2.1. Mục 5.1 định nghĩa các tham số và giải thích vì sao các bản tóm tắt gộp và theo-trạm phải được báo cáo cùng nhau. Mục 5.2 báo cáo kết quả nội suy thời gian (đánh giá chéo ngẫu nhiên) --- kỳ vọng ban đầu mà phần lớn tài liệu khoa học đánh giá --- và xác nhận rằng mô hình có năng lực tái dựng động học PM2.5 tại các trạm đã biết. Mục 5.3 trình bày ngoại suy không gian (LOSO) --- bài toán trọng tâm --- và định lượng khoảng cách giữa kỳ vọng ban đầu và hiệu suất thực tế khi dự đoán tại vị trí mới. Mục 5.4 phân tầng kết quả LOSO theo mức ô nhiễm, xác lập gradient đơn điệu, bất biến-mô-hình mà theo đó khả năng dự đoán tỷ lệ với mức ô nhiễm --- đồng thời coi khẳng định xa hơn rằng mức chứ không phải vùng chi phối kỹ năng đó là một giả thuyết mà dữ liệu chưa thể tách bạch --- và cô lập mức tăng do phân tầng (khoảng +0,17 trong-cùng-tệp, lên đến +0,26 qua các cách diễn đạt). Mục 5.5 so sánh mọi cấu hình thực sự triển khai được với ngưỡng trần oracle và đo chi phí thông tin của việc không biết trung bình của một trạm. Mục 5.6 trình bày đánh giá độc lập với mạng lưới cảm-biến-chi-phí-thấp và trạm tham chiếu Đại sứ quán Hoa Kỳ. Mục 5.7 tổng hợp bảy họ thí nghiệm không thành công vốn giới hạn không gian giải pháp. Mục 5.8 gắn kết nội suy thời gian và ngoại suy không gian dưới một nguyên lý thống nhất giải thích vì sao cùng một mô hình trải dài R\textsuperscript{2} từ dưới 0,1 đến trên 0,8. Xuyên suốt, chuỗi ba-con-số trọng tâm đã nêu ở Chương 1 được làm rõ: R\textsuperscript{2} khoảng 0,80 cho nội suy thời gian, khoảng 0,20 cho ngoại suy không gian, và một trung vị theo trạm triển khai được gần 0,04.


\section{Các tham số đánh giá}

Tất cả các mô hình trong luận văn này được đánh giá so với PM2.5 thực địa theo giờ bằng bốn tham số. Hệ số xác định được tính ở độ phân giải theo giờ, ký hiệu R\textsuperscript{2}\_hourly, đo phần phương sai trong các nồng độ theo giờ quan trắc mà mô hình giải thích so với một đường cơ sở trung-bình-hằng-số; nó là tham số nổi bật chính và bị chặn trên bởi 1, bằng 0 khi mô hình không làm tốt hơn việc dự đoán trung bình dài hạn, và không bị chặn dưới, trở nên âm bất cứ khi nào mô hình tệ hơn trung bình đó. Sai số quân phương trung bình (RMSE) và sai số tuyệt đối trung bình (MAE), cả hai tính bằng $\mu$g/m\textsuperscript{3}, định lượng độ lớn điển hình của sai số dự đoán, với RMSE đặt trọng số nặng hơn cho các sai số lớn; và độ thiên lệch (bias), phần dư có dấu trung bình tính bằng $\mu$g/m\textsuperscript{3}, ghi lại sự dự đoán vượt hoặc thiếu một cách hệ thống. Các tham số này được báo cáo cùng với R\textsuperscript{2} bởi vì hai mô hình có R\textsuperscript{2} giống hệt nhau có thể khác biệt đáng kể về độ chính xác tuyệt đối, và bởi vì tại các vị trí sạch một R\textsuperscript{2} gần-không hoặc âm cùng tồn tại với một RMSE nhỏ --- phương sai cần giải thích bản thân nó đã nhỏ.

Một điểm phương pháp luận trọng tâm của chương này là sự phân định giữa R\textsuperscript{2} gộp và R\textsuperscript{2} trung bình (hoặc trung vị) theo trạm, và lý do cả hai phải được báo cáo. R\textsuperscript{2} gộp được tính bằng cách nối các phần dư theo giờ của tất cả các trạm thành một vectơ duy nhất và đánh giá hệ số xác định một lần trên toàn bộ bộ dữ liệu; nó bị chi phối bởi các trạm phương sai cao, nồng độ cao bởi vì các trạm đó đóng góp cả phần phương sai nhiều nhất cần giải thích và, thường, số giờ nhiều nhất. R\textsuperscript{2} theo trạm, ngược lại, được tính riêng cho từng trạm giữ lại rồi được tóm tắt qua các trạm bằng trung bình hoặc trung vị của nó; nó đặt trọng số mỗi trạm bằng nhau bất kể nồng độ hay độ dài bản ghi của nó và do đó phơi bày cách mô hình hoạt động tại vị trí điển hình thay vì tại số ít vị trí chi phối phương sai gộp. Hai con số phân kỳ mạnh trong bộ dữ liệu này: một số ít trạm sạch, phương sai thấp với R\textsuperscript{2} âm kéo trung bình theo trạm xuống thấp hơn nhiều so với trung vị theo trạm, trong khi con số gộp, được neo bởi các trạm phía Bắc ô nhiễm, nằm cao hơn cả hai. Việc chỉ báo cáo một trong ba bản tóm tắt sẽ gây hiểu lầm một cách hệ thống --- giá trị gộp phóng đại hiệu suất điển hình, trung bình theo trạm hạ thấp nó vì một số ít vị trí sạch âm nặng, và trung vị theo trạm là xu hướng trung tâm bền vững nhất. Ở nơi một kết quả phụ thuộc vào lựa chọn bản tóm tắt, cả ba đều được đưa ra. Một lưu ý thực tiễn áp dụng xuyên suốt: các tệp kết quả LOSO theo trạm chỉ lưu R\textsuperscript{2}\_hourly theo trạm (cùng với RMSE, MAE, và bias đi kèm) và không giữ lại các phần dư theo giờ thô, nên đối với các thí nghiệm đó một R\textsuperscript{2} gộp liên-trạm thực sự không thể được tính lại sau khi đã xong; ở nơi thuật ngữ "gộp" được dùng cho các cấu hình LOSO, nó biểu thị trung bình có trọng số-số-giờ của các giá trị theo trạm, điều được nêu rõ ở mỗi lần sử dụng và không giống hệt với một R\textsuperscript{2} vectơ-phần-dư duy nhất.

Một chỉ báo thứ ba, thực tiễn một cách có chủ ý, đi kèm với các tham số phương sai: tỷ lệ phần trăm các trạm giữ lại đạt R\textsuperscript{2} dương. Bởi vì một R\textsuperscript{2} âm nghĩa là mô hình tệ hơn việc chỉ đơn giản giả định trung bình dài hạn riêng của trạm, tỷ lệ các trạm trên không trả lời một câu hỏi mà R\textsuperscript{2} trung bình che khuất --- tại bao nhiêu vị trí mô hình thực sự sẽ hữu dụng như một bộ ước tính được triển khai? Một cấu hình có thể đăng một R\textsuperscript{2} trung bình đáng nể trong khi thất bại hoàn toàn tại gần một nửa số trạm của nó, và chỉ báo tỷ-lệ-dương là cái phơi bày thất bại đó. Nó được báo cáo cho mọi cấu hình LOSO và đánh giá độc lập trong chương này.


\section{Nội suy thời gian (đánh giá chéo ngẫu nhiên)}

Chế độ đánh giá đầu tiên là đánh giá chéo ngẫu nhiên --- phương pháp đánh giá phù hợp cho bài toán nội suy thời gian (Mục 2.1.1). Trong chế độ này 244.489 quan trắc theo giờ của mô hình chính được xáo trộn và phân hoạch không quan tâm đến danh tính trạm, sao cho các giờ từ mọi trạm xuất hiện ở cả fold huấn luyện và fold kiểm tra. Một làm rõ về tên gọi là cần thiết ngay từ đầu: kế hoạch dự án ban đầu mô tả đây là đánh giá chéo mười-fold, nhưng phần triển khai tạo ra các tệp kết quả sử dụng một phân hoạch xáo trộn năm-fold (một phép chia KFold với năm fold, bật xáo trộn, và một hạt giống ngẫu nhiên cố định). Không có tệp kết quả mười-fold nào tồn tại ở bất cứ đâu trong bản ghi thực nghiệm; do đó khẳng định được hỗ trợ là đánh giá chéo ngẫu nhiên năm-fold, và các con số dưới đây được báo cáo trên cơ sở đó. Sự phân định không ảnh hưởng đến con số nổi bật --- số lượng fold thay đổi ước tính phương sai, không phải xu hướng trung tâm --- nhưng nó được ghi lại ở đây để chính xác.

Mô hình được đánh giá trong chế độ này là Config H --- ba mươi hai đặc trưng dẫn dắt một bộ hồi quy XGBoost-DART với tám trăm cây ở độ sâu tám --- cấu hình mà kết quả đánh giá chéo ngẫu nhiên đã được tính. Mô hình hoàn chỉnh sáu mươi sáu đặc trưng được mô tả ở Chương 3 được mô tả đặc trưng dưới đánh giá bỏ-một-trạm-ra thay vì chạy lại dưới đánh giá chéo ngẫu nhiên; do đó khoảng cách bài toán của Mục 5.3 được chứng minh trên Config H, cấu hình duy nhất mà cả hai chế độ đều được đánh giá trên một mô hình giống hệt, và mô hình hoàn chỉnh là đối tượng của phân tích không gian từ Mục 5.3 trở đi. Dưới đánh giá chéo ngẫu nhiên năm-fold, Config H đạt R\textsuperscript{2} ngoài-fold là 0,8125, với MAE gộp 7,63 $\mu$g/m\textsuperscript{3} và RMSE 11,12 $\mu$g/m\textsuperscript{3} trên tất cả 244.489 giờ. Đây là "con số bài-báo-công-bố" --- con số trực tiếp so sánh được với các kết quả R\textsuperscript{2} > 0,8 chi phối tài liệu khoa học cho Trung Quốc, Hoa Kỳ, và châu Âu --- và nó là giá trị đã nêu ở Chương 1 như neo đánh-giá-chéo-ngẫu-nhiên khoảng 0,80. Kết quả ổn định qua các fold: năm giá trị R\textsuperscript{2} ngoài-fold chỉ trải từ 0,8078 đến 0,8172, một độ trải dưới một điểm rất nhiều, xác nhận rằng con số 0,81 không phải là một hiện vật của một phân hoạch may mắn.

{\small
\begin{longtable}{l}
\caption{R\textsuperscript{2} ngoài-fold theo từng fold của Config H dưới đánh giá chéo ngẫu nhiên năm-fold, với giá trị gộp.}\\
\toprule
\textbf{Config H ĐẦY ĐỦ --- R\textsuperscript{2} đánh giá chéo ngẫu nhiên theo từng fold} \\
\midrule\endhead
fold 0 = 0,8141 \\
fold 1 = 0,8095 \\
fold 2 = 0,8139 \\
...
\textbf{Config H ĐẦY ĐỦ (mô hình chính)} & \textbf{32} & \textbf{0,8125} & \textbf{7,63} & \textbf{11,12} \\
...
Các quét độ bền độc lập dưới các hạt giống fold thay thế chứng thực mức này: trên năm tệp thí nghiệm KFold riêng biệt, mô hình lớp-Config-H trả về các giá trị R\textsuperscript{2} tụ giữa 0,7225 và 0,8117, với RMSE gần 11--13 $\mu$g/m\textsuperscript{3} và MAE gần 6,5--8,0 $\mu$g/m\textsuperscript{3}, xác nhận rằng khoảng 0,80--0,81 là hiệu suất đánh giá chéo ngẫu nhiên thực sự của mô hình này chứ không phải một lần chạy thuận lợi đơn lẻ.

Điều mà chế độ này xác lập, và điều nó không, phải được nêu chính xác. Nó xác nhận rằng tập đặc trưng và thuật toán học có khả năng biểu diễn động học theo giờ của PM2.5 Việt Nam: cho các giờ từ một trạm trong huấn luyện, mô hình tái dựng các giờ còn lại của trạm đó đến trong vòng một R\textsuperscript{2} 0,81. Đây là kết quả hợp lệ cho bài toán nội suy thời gian --- mô hình biết trạm này ``là loại trạm nào'' và chỉ cần dự đoán các độ lệch quanh một đường cơ sở đã biết. Con số 0,81 không bị phóng đại hay ``rò rỉ'' trong bối cảnh bài toán mà nó đánh giá; nó đơn giản là đo một bài toán khác với bài toán trọng tâm của luận văn. Khoảng cách giữa con số này và hiệu suất LOSO ở Mục 5.3 phản ánh sự khác biệt cơ bản giữa hai bài toán --- biết ``đây là loại vị trí nào'' so với phải suy luận điều đó từ các quan trắc vệ tinh và các trạm lân cận.


\section{Ngoại suy không gian (LOSO --- cấu hình toàn cục)}

Đánh giá chéo bỏ-một-trạm-ra đánh giá bài toán ngoại suy không gian (Mục 2.1.2) --- bài toán trọng tâm của luận văn. Mỗi trong ba mươi bảy trạm được giữ lại lần lượt, mô hình được huấn luyện lại trên các trạm còn lại với trạm giữ lại bị loại khỏi tập lân cận của mọi trạm khác, và trạm giữ lại sau đó được dự đoán như thể nó là một vị trí không có quan trắc. Đây là bài toán có ý nghĩa vận hành --- ước tính PM2.5 ở nơi không có phép đo mặt đất --- và nó là tham số đánh giá chính của luận văn này.

Một làm rõ về nguồn là cần thiết, bởi vì các cấu hình LOSO toàn cục được phân bố trên một số tệp thí nghiệm chứ không tập trung trong một. Tệp biến-thể-mô-hình definitive\_v3 chứa sáu biến thể huấn luyện DART --- một mô hình cơ sở, ba biến thể trạm-lân-cận, một mô hình được tinh chỉnh, và một tổ hợp --- mỗi biến thể mang nhãn bốn-tầng thực và do đó là một mô hình true-tier; biến thể được tinh chỉnh trong tệp đó giống-hệt-từng-byte, trên tất cả ba mươi bảy trạm, với cấu hình được gán nhãn "T4F" trong tệp thí-nghiệm-phân-nhóm, điều này xác lập liên kết giữa hai. Mô hình toàn cục thực sự mù-tầng --- một mô hình gộp duy nhất không phân nhóm tầng --- là cấu hình "no-grouping" trong tệp thí-nghiệm-phân-nhóm, và cận trên oracle tiêm trung bình PM2.5 thực của mỗi trạm giữ lại như một độ dời cộng tính là cấu hình "oracle base-margin" trong tệp hai-pha. Ba cấu hình này là các đối tượng riêng biệt, và việc phân biệt chúng là thiết yếu bởi vì chuỗi LOSO nổi bật phụ thuộc vào cái nào là cái nào.

Sự tương phản với đánh giá chéo ngẫu nhiên là kết quả trọng tâm của chương. Cùng một mô hình Config H đạt 0,8125 khi đánh giá nội suy thời gian (đánh giá chéo ngẫu nhiên năm-fold) nhưng chỉ còn R\textsuperscript{2} trung bình theo trạm 0,2093 khi đánh giá ngoại suy không gian (LOSO theo giờ) --- một chênh lệch 0,603. Trung vị theo trạm dưới LOSO là 0,3305, MAE gộp tăng lên 11,99 $\mu$g/m\textsuperscript{3}, và RMSE lên 16,86 $\mu$g/m\textsuperscript{3}. Khoảng cách 0,603 không nên được hiểu là ``rò rỉ'' hay ``phóng đại'' --- nó phản ánh sự khác biệt cơ bản giữa hai bài toán: nội suy thời gian được hưởng lợi từ việc biết lịch sử của trạm, trong khi ngoại suy không gian phải suy luận ``đây là loại vị trí nào'' mà không có bất kỳ tiên nghiệm nào từ chính vị trí đó. Chiều rộng của khoảng cách này là nội dung định lượng của khẳng định phương pháp luận trọng tâm: thông tin về bản sắc trạm --- mức ô nhiễm nền, chế độ theo mùa, vi mô hình đô thị --- là nguồn kỹ năng chính, và ngoại suy không gian đòi hỏi các kỹ thuật riêng để bù đắp cho sự thiếu hụt thông tin này.

Một điểm chính xác về cái mà khoảng cách 0,603 lấy hiệu số. Con số LOSO theo giờ 0,2093 là kết quả của lần chạy Config H mười-lăm-trạm, trong đó mô hình Config H ba mươi hai đặc trưng được huấn luyện lại theo từng trạm giữ lại; nó khác biệt với mô hình hoàn chỉnh ba mươi bảy trạm được báo cáo từ Mục 5.3 trở đi, mà trung bình theo trạm của nó là 0,1989. Do đó khoảng cách giữa hai bài toán được đo trên mô hình Config H giống hệt --- R\textsuperscript{2} nội suy thời gian (KFold ngoài-fold 244.489-giờ) là 0,8125 so với R\textsuperscript{2} ngoại suy không gian (bỏ-một-trạm-ra) là 0,2093 --- chứ không phải bằng cách lấy hiệu số hai mô hình được đánh giá trên các tập trạm khác nhau. Hai con số LOSO, 0,2093 (Config H, mười lăm trạm) và 0,1989 (mô hình hoàn chỉnh, ba mươi bảy trạm), thống nhất chặt chẽ và cả hai đều hiện thực hóa neo LOSO khoảng 0,20, nhưng chỉ con số đầu chia sẻ mô hình của nó với con số nội-suy-thời-gian và do đó là con số được dùng để định lượng khoảng cách giữa hai bài toán.

{\small
\begin{longtable}{llll}
\caption{R\textsuperscript{2} và MAE của Config H qua các bài toán dự đoán, từ nội suy thời gian (đánh giá chéo ngẫu nhiên) đến ngoại suy không gian (LOSO huấn-luyện-lại-theo-fold), với khoảng cách giữa hai bài toán.}\\
\toprule
\textbf{Bài toán / Chế độ đánh giá (Config H, 32 đặc trưng)} & \textbf{R\textsuperscript{2}} & \textbf{MAE} & \textbf{Ghi chú} \\
\midrule\endhead
Nội suy thời gian --- CV ngẫu nhiên 5-fold & 0,8125 & 7,63 & biết danh tính trạm \\
LOSO theo ngày giả, chỉ mô hình (dùng CV theo giờ) & 0,8684 & 3,77 & thực chất là nội suy thời gian \\
LOSO theo ngày giả, mô hình + AOD + kriging (dùng CV theo giờ) & 0,8882 & 3,32 & thực chất là nội suy thời gian \\
Ngoại suy không gian --- LOSO theo ngày thực & 0,168 & --- & huấn luyện lại theo từng trạm giữ lại \\
Ngoại suy không gian --- LOSO theo giờ (tham số chính) & 0,2093 & 11,99 & Config H, LOSO trung thực 15-trạm \\
\textbf{Khoảng cách bài toán (nội suy thời gian $-$ ngoại suy không gian)} & \textbf{$-$0,6032} & --- & chi phí mất thông tin trạm \\
\bottomrule
\end{longtable}
}


Bảng này cũng ghi lại một kết quả trung gian mang tính cảnh báo. Một đánh giá độ-phân-giải-theo-ngày trước đó báo cáo một R\textsuperscript{2} LOSO có vẻ xuất sắc 0,8684 cho chỉ mô hình, tăng lên 0,8882 khi AOD vệ tinh và hậu xử lý kriging-thông-thường được thêm vào. Các con số này thực chất đánh giá nội suy thời gian chứ không phải ngoại suy không gian. Mặc dù được gán nhãn ``LOSO'' trong script tạo ra chúng, các dự đoán theo giờ cấp cho chúng đến từ một KFold năm-fold được huấn luyện trên tất cả các trạm rồi được tổng hợp thành các giá trị theo ngày và kriged qua các trạm theo từng ngày, nên danh tính trạm được bảo toàn qua giai đoạn theo giờ. LOSO theo ngày thực sự (huấn luyện lại cho mỗi trạm giữ lại) chỉ đạt 0,168 cho chỉ mô hình và 0,224 với kriging. Ví dụ này minh họa tầm quan trọng của việc phân biệt rõ ràng bài toán nào đang được đánh giá: cùng một nhãn ``LOSO'' có thể che giấu một đánh giá nội suy thời gian nếu quy trình huấn luyện không loại trừ hoàn toàn trạm giữ lại. Mọi con số nổi bật trong luận văn này được báo cáo dưới LOSO huấn-luyện-lại-theo-fold tường minh, đảm bảo chúng đo lường ngoại suy không gian thực sự.

Chuyển sang các cấu hình LOSO toàn cục đúng nghĩa, vai trò của phân nhóm tầng là quyết định. Mô hình toàn cục mù-tầng thực sự không phân nhóm đạt một R\textsuperscript{2}\_hourly gộp có trọng số-số-giờ chỉ 0,0387, một trung bình theo trạm 0,0273, một trung vị theo trạm -0,0012, và chỉ 48,6\% số trạm dương --- tức là, một mô hình gộp duy nhất không biết chế độ ô nhiễm của mỗi trạm về cơ bản là vô dụng cho ngoại suy không gian, thất bại tại hơn một nửa tất cả các trạm. Việc tiêm nhãn tầng thực (cấu hình T4F, giống hệt biến thể được tinh chỉnh trong definitive\_v3) nâng R\textsuperscript{2} gộp lên 0,2004, trung bình lên 0,1989, trung vị lên 0,1787, và tỷ lệ dương lên 70,3\%. Đây là cấu hình phi-oracle tốt nhất theo định nghĩa riêng của luận văn và là sự hiện thực hóa neo LOSO khoảng 0,20 đã nêu ở Chương 1. Một kiểm tra chéo độc lập trong một tệp thí nghiệm riêng tái lập sự tương phản: một cấu hình oracle-tier ở đó đạt gộp 0,2074 so với -0,0438 cho đối ứng không-phân-nhóm của nó, xác nhận hiệu ứng không đặc thù cho một tệp.

{\small
\begin{longtable}{lllllllll}
\caption{Các cấu hình LOSO toàn cục qua các tệp thí nghiệm --- không phân nhóm, true-tier (T4F), và oracle base-margin --- với R\textsuperscript{2} gộp, trung bình, trung vị, tỷ lệ dương, và trung bình t3.}\\
\toprule
\textbf{Tệp} & \textbf{Cấu hình} & \textbf{Vai trò} & \textbf{n} & \textbf{Gộp (ts n-giờ)} & \textbf{Trung bình} & \textbf{Trung vị} & \textbf{\% > 0} & \textbf{tb t3} \\
\midrule\endhead
satellite\_grouping & no\_group & Toàn cục không phân nhóm & 37 & 0,0387 & 0,0273 & -0,0012 & 48,6\% & 0,2683 \\
satellite\_grouping & t4f (= dart\_tuned) & T4F true-tier (phi-oracle tốt nhất) & 37 & 0,2004 & 0,1989 & 0,1787 & 70,3\% & 0,5682 \\
twophase\_bm & oracle\_bm & Oracle base-margin (độ dời tb thực) & 40 & 0,2487 & 0,2464 & 0,2669 & 82,5\% & 0,5011 \\
twophase\_bm & global\_bm & Base-margin đơn toàn cục & 40 & -0,0602 & -0,0733 & 0,0261 & 55,0\% & 0,2402 \\
tier\_operational & oracle\_t4f & Oracle true-tier (kiểm tra chéo) & 40 & 0,2074 & 0,1980 & 0,1547 & 75,0\% & 0,5666 \\
tier\_operational & no\_t4f & Không phân nhóm (kiểm tra chéo) & 40 & -0,0438 & -0,0615 & 0,0142 & 52,5\% & 0,2552 \\
\bottomrule
\end{longtable}
}


Sáu biến thể DART trong definitive\_v3 chỉ khác nhau một cách cận biên với nhau, tất cả đều tụ gần con số nổi bật 0,20: tổ hợp cao nhất ở gộp 0,2061 và trung bình theo trạm 0,2048, biến thể được tinh chỉnh (T4F) theo sau ở 0,2004 gộp và 0,1989 trung bình, và mô hình cơ sở chưa-tinh-chỉnh đứng cuối ở 0,1912 gộp và 0,1902 trung bình. Sự hẹp của độ trải này --- dưới 0,02 về trung bình theo trạm qua sáu chiến lược huấn luyện --- chỉ ra rằng ngưỡng trần LOSO cho mô hình true-tier toàn cục được đặt bởi thông tin sẵn có, không phải bởi lựa chọn chính quy hóa hay tổ hợp. Việc giới hạn sự chú ý vào tập ba-mươi-bảy-trạm đã-loại-cảm-biến-hỏng thay vì tập bốn-mươi-trạm nâng các trung vị một chút cho các cấu hình oracle, nhưng thứ tự bất biến.

{\small
\begin{longtable}{llllll}
\caption{Sáu biến thể huấn luyện DART trong definitive\_v3, tất cả đều tụ gần ngưỡng trần LOSO 0,20, sắp xếp theo R\textsuperscript{2} gộp.}\\
\toprule
\textbf{Cấu hình} & \textbf{Gộp (ts n-giờ)} & \textbf{Trung bình} & \textbf{Trung vị} & \textbf{\% > 0} & \textbf{tb t3 (n=9)} \\
\midrule\endhead
dart\_ensemble & 0,2061 & 0,2048 & 0,2030 & 73,0\% & 0,5639 \\
dart\_tuned (= T4F) & 0,2004 & 0,1989 & 0,1787 & 70,3\% & 0,5682 \\
dart\_nn23\_pruned & 0,1996 & 0,1987 & 0,1881 & 70,3\% & 0,5608 \\
dart\_nn23 & 0,1971 & 0,1969 & 0,2074 & 73,0\% & 0,5622 \\
dart\_nn23\_dow & 0,1932 & 0,1930 & 0,1929 & 73,0\% & 0,5606 \\
dart\_base & 0,1912 & 0,1902 & 0,1819 & 70,3\% & 0,5548 \\
\bottomrule
\end{longtable}
}


Phân tách theo trạm của cấu hình phi-oracle tốt nhất (T4F, biến thể được tinh chỉnh của definitive\_v3) cho thấy rằng con số nổi bật trung bình 0,20 che giấu một dải khổng lồ và một sự phân tầng sạch sẽ theo mức ô nhiễm. Kỹ năng tăng đơn điệu với nồng độ: các trạm ô nhiễm nhất được dự đoán tốt, với trạm tốt nhất --- Hưng Yên trên Nguyễn Văn Linh, PM2.5 trung bình 43,2 $\mu$g/m\textsuperscript{3} --- đạt R\textsuperscript{2} 0,7553, trong khi các trạm sạch phương sai thấp được dự đoán kém hoặc tệ hơn trung bình riêng của chúng, tệ nhất là Trà Vinh Dân Thành ở trung bình 9,1 $\mu$g/m\textsuperscript{3} và R\textsuperscript{2} -0,8139. Bảng đầy đủ ba-mươi-bảy-trạm dưới đây được sắp xếp theo tầng rồi theo R\textsuperscript{2} trong tầng, làm cho sự phân tầng hiện rõ trực tiếp.

{\small
\begin{longtable}{llll}
\caption{R\textsuperscript{2} LOSO trung thực theo trạm cho cấu hình phi-oracle tốt nhất (T4F), tất cả ba mươi bảy trạm sắp xếp theo tầng rồi theo R\textsuperscript{2} trong tầng.}\\
\toprule
\textbf{Tầng} & \textbf{Trạm} & \textbf{Trung bình PM2.5} & \textbf{R\textsuperscript{2}\_hourly} \\
\midrule\endhead
...
Kỹ năng LOSO theo trạm được ánh xạ về mặt địa lý trong Hình 5.1, với ba mươi bảy trạm được vẽ trên bản đồ nền Việt Nam và tô màu theo R\textsuperscript{2}.

\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{fig_5_3_station_r2_map.png}
\caption{R\textsuperscript{2} bỏ-một-trạm-ra theo trạm trên 37 trạm quan trắc, tô màu theo kỹ năng.}
\end{figure}


Mẫu không gian có thể được đọc trực tiếp từ bảng theo trạm, bởi vì kỹ năng bám theo mức ô nhiễm và mức ô nhiễm có một chữ ký địa lý mạnh. Các trạm kỹ-năng-cao tụ chặt ở đồng bằng sông Hồng phía Bắc --- Hưng Yên, Hà Nam, Hải Dương, ba vị trí Hà Nội, Thái Bình, Thái Nguyên, và Bắc Ninh đều vượt R\textsuperscript{2} 0,4 --- tạo thành một vùng hiệu-suất-cao liền mạch quanh Hà Nội. Một túi kỹ năng cao thứ hai thì cô lập và phía Nam: hai trạm Thành phố Hồ Chí Minh đạt các giá trị R\textsuperscript{2} 0,61 và 0,58, đứng tách biệt khỏi các vị trí phía Nam kỹ-năng-thấp xung quanh. Phần còn lại của bản đồ sẽ hiện ra chủ yếu trong dải thấp và âm: cụm ven-biển-công-nghiệp Quảng Ninh ở phía đông bắc, các trạm ven biển miền Trung từ Đà Nẵng xuống Bình Định, và các vị trí đồng bằng sông Cửu Long sạch đều rơi gần hoặc dưới không. Do đó ấn tượng thị giác sẽ là một đồng bằng phía Bắc sáng, liền mạch, hai điểm đô thị phía Nam sáng nhưng cô lập, và một vành đai mờ nhạt --- một địa lý mà, như Mục 5.4 lập luận, được đọc một cách tiết kiệm nhất như một địa lý của mức ô nhiễm, mà vùng miền bị lẫn lộn một phần với nó trong mạng lưới này.

Sự sụp đổ LOSO này đặt luận văn vững chắc trong tài liệu khoa học quốc tế về đánh giá không gian. Kawano et al. \cite{kawano2025}, với khoảng một nghìn trạm huấn luyện trên khắp Ấn Độ, đã thấy R\textsuperscript{2} của họ rơi từ 0,85 dưới đánh giá chéo ngẫu nhiên xuống 0,67 dưới đánh giá chéo không gian --- một mức giảm tương đối nhẹ 0,18, được duy trì bởi mật độ mạng lưới. Meyer et al. \cite{meyer2018} báo cáo một mức rơi từ 0,90 xuống 0,24, và Ploton et al. \cite{ploton2020} một mức rơi từ 0,53 xuống 0,14 --- các sụp đổ lần lượt là 0,66 và 0,39, cùng bậc với mức giảm 0,60 được ghi nhận ở đây. Khoảng cách của Việt Nam (0,81 xuống 0,21) lớn hơn nhiều của Ấn Độ vì mạng lưới của Việt Nam thưa hơn nhiều; do đó kết quả luận văn nhất quán với phê phán trong tài liệu khoa học và mở rộng nó đến một bối cảnh nhiệt đới, mạng-lưới-thưa nơi hình phạt không gian ở mức nghiêm trọng nhất.


\section{Kết quả phân tầng theo mức ô nhiễm}

Bảng theo trạm của Mục 5.3 đã gợi ý phát hiện diễn giải quan trọng nhất của chương: kỹ năng được tổ chức theo mức ô nhiễm. Mục này làm cho sự tổ chức đó định lượng bằng cách phân tách kết quả LOSO true-tier theo tầng. Một làm rõ về nguồn phản chiếu mục trước: tệp biến-thể-mô-hình definitive\_v3 không chứa một cấu hình mang tên đúng nghĩa "oracle T4F," nhưng mỗi trong sáu biến thể DART của nó mang nhãn bốn-tầng thực và do đó thực chất là một mô hình true-tier (oracle-tier); phân tách theo tầng dưới đây được báo cáo cho biến thể cơ sở, vốn khớp gần nhất với các con số tầng đã nêu và mức tăng +0,21, với biến thể tổ hợp tốt nhất tổng thể được đưa ra bên cạnh nó. So sánh oracle-tier-so-với-không-phân-nhóm mang tên đúng nghĩa nằm trong tệp vận hành ghép đôi và được dùng làm kiểm tra chéo cho phép tính mức tăng.

Mẫu theo tầng rõ ràng và đơn điệu. Tầng ô nhiễm cao nhất t3, gồm chín trạm với PM2.5 trung bình 44,1 $\mu$g/m\textsuperscript{3}, đạt R\textsuperscript{2} trung bình 0,5548 (trung vị 0,6084). Tầng trung bình t2 --- mười một trạm, trung bình 24,0 $\mu$g/m\textsuperscript{3} --- rơi xuống R\textsuperscript{2} trung bình 0,3154 (trung vị 0,2953). Tầng thấp t1 --- mười trạm, trung bình 14,0 $\mu$g/m\textsuperscript{3} --- tụt xuống R\textsuperscript{2} trung bình -0,0302 (trung vị 0,0438), về cơ bản là đường không-kỹ-năng. Và tầng sạch t0 --- bảy trạm, trung bình 8,0 $\mu$g/m\textsuperscript{3} --- âm một cách có ý nghĩa trên trung bình ở -0,1604 (trung vị -0,0534), phản ánh rằng tại các vị trí sạch nhất mô hình không thể vượt qua trung bình riêng của trạm. Do đó dạng viết tắt đã nêu t3 $\approx$ 0,56, t2 $\approx$ 0,31, t1 $\approx$ 0, t0 $\approx$ 0 được xác nhận trên trung bình cho t3 và t2 và về mặt hướng cho t1 và t0, với hiệu chỉnh nhỏ rằng trung bình t0 dưới không một cách đáng kể chứ không phải tại không --- trung vị của nó, -0,053, là bản tóm tắt khoan dung hơn nhưng vẫn dưới-không.

Bởi vì mỗi tầng chỉ giữ một số ít trạm, các trung bình theo tầng này mang độ bất định lấy mẫu đáng kể và được báo cáo kèm nó. Trên biến thể cơ sở các sai số chuẩn của R\textsuperscript{2} trung bình theo tầng là khoảng 0,13 (t0, n = 7), 0,065 (t1, n = 10), 0,066 (t2, n = 11), và 0,078 (t3, n = 9), tương ứng với các nửa-độ-rộng khoảng tin cậy 95\% khoảng 0,15--0,18 mỗi tầng (đối với t3, n = 9, SD $\approx$ 0,234, nửa-độ-rộng CI $\approx$ 0,15). Hai trong ba khoảng cách tầng-liền-kề có kích thước tương đương với độ bất định lấy mẫu này: khoảng cách t0$\rightarrow$t1 (khoảng +0,13) nhỏ hơn độ bất định kết hợp của hai trung bình, và ngay cả khoảng cách t2$\rightarrow$t3 (khoảng +0,24) cũng chỉ lớn hơn nó một cách khiêm tốn; khoảng cách t1$\rightarrow$t2 (khoảng +0,35) là chuyển tiếp duy nhất vượt sàn nhiễu một cách dứt khoát. Thứ tự đơn điệu nhất quán qua tất cả sáu biến thể, nên gradient như một tổng thể không phải một hiện vật của lấy mẫu, nhưng các gia số tầng-sang-tầng riêng lẻ --- và các trung bình tầng chính xác --- nên được đọc như các ước tính điểm được bao quanh bởi các khoảng cỡ $\pm$0,15 chứ không phải như các mức được tách biệt sắc nét.

{\small
\begin{longtable}{llllllll}
\caption{Kết quả LOSO trung thực phân tầng cho biến thể DART cơ sở --- số trạm theo tầng, trung bình PM2.5, R\textsuperscript{2}, RMSE, MAE, và bias.}\\
\toprule
\textbf{Tầng} & \textbf{n trạm} & \textbf{Tb PM2.5} & \textbf{Tb R\textsuperscript{2}\_hourly} & \textbf{Trung vị R\textsuperscript{2}\_hourly} & \textbf{Tb RMSE} & \textbf{Tb MAE} & \textbf{Tb bias} \\
\midrule\endhead
...
{\small
\begin{longtable}{llllllll}
\caption{Kết quả LOSO trung thực phân tầng cho biến thể tổ hợp tốt nhất tổng thể, cho thấy cùng cấu trúc đơn điệu cao hơn một cách cận biên ở mỗi tầng.}\\
\toprule
\textbf{Tầng} & \textbf{n trạm} & \textbf{Tb PM2.5} & \textbf{Tb R\textsuperscript{2}\_hourly} & \textbf{Trung vị R\textsuperscript{2}\_hourly} & \textbf{Tb RMSE} & \textbf{Tb MAE} & \textbf{Tb bias} \\
\midrule\endhead
...
{\small
\begin{longtable}{llll}
\caption{Mức tăng do phân tầng qua các biến thể và tập trạm, mỗi mục lấy hiệu số một trung bình true-tier so với một đường cơ sở không-phân-nhóm.}\\
\toprule
\textbf{So sánh} & \textbf{Trung bình T4F} & \textbf{Trung bình không phân nhóm} & \textbf{Mức tăng} \\
\midrule\endhead
dart\_base (37) vs no\_t4f (37) & 0,1902 & -0,0286 & +0,219 \\
dart\_ensemble (37) vs no\_t4f (37) & 0,2048 & -0,0286 & +0,233 \\
oracle\_t4f (37) vs no\_t4f (37) & 0,2067 & -0,0286 & +0,235 \\
oracle\_t4f (40) vs no\_t4f (40) & 0,1980 & -0,0615 & +0,260 \\
\bottomrule
\end{longtable}
}


\section{So sánh các mô hình triển khai được}
...
Ngưỡng trần oracle, ngược lại, cao hơn nhiều. Việc tiêm trung bình theo trạm thực của trạm giữ lại như một biên cơ sở cộng tính nâng R\textsuperscript{2} trung bình theo trạm lên giữa +0,25 và +0,31 --- +0,306 trên tập ba-mươi-bảy-trạm đã-loại-cảm-biến-hỏng, +0,254 đến +0,271 trên các tập bốn-mươi-trạm --- với 85\% đến 92\% số trạm dương. Điều này xác nhận ngưỡng trần oracle đã nêu khoảng +0,27 trung bình theo trạm với khoảng 92\% dương. Cấu hình cổng-mềm-cộng-trung-bình-thực bị gán nhãn sai, nay được phân loại đúng là oracle, tái lập ngưỡng trần một cách độc lập ở đúng +0,270 trung bình và 92,5\% dương.

{\small
\begin{longtable}{llllllll}
\caption{Các cấu hình triển khai được so với các ngưỡng trần oracle --- R\textsuperscript{2} trung bình, trung vị, tỷ lệ dương, và trung bình t3, với mỗi cấu hình được gắn cờ là triển khai được hay oracle.}\\
\toprule
\textbf{Cấu hình} & \textbf{Nguồn} & \textbf{Triển khai} & \textbf{Tb R\textsuperscript{2}} & \textbf{Trung vị R\textsuperscript{2}} & \textbf{\% > 0} & \textbf{tb t3} & \textbf{n} \\
\midrule\endhead
soft\_gate\_moe & soft\_gate\_moe & có & +0,0447 & -0,0187 & 47,5\% & +0,4129 & 40 \\
no\_t4f & irm\_invariant & có & -0,0615 & +0,0142 & 52,5\% & +0,2552 & 40 \\
balanced & irm\_invariant & có & -0,0508 & +0,0415 & 57,5\% & +0,2445 & 40 \\
direct & satellite\_v5b & có & -0,0178 & +0,0428 & 55,0\% & +0,3094 & 40 \\
clust\_bm\_rfsi & satellite\_v5g & có & +0,0292 & +0,0189 & 54,1\% & +0,4249 & 37 \\
clust\_bm & satellite\_v5g & có & -0,0067 & +0,0117 & 51,4\% & +0,2413 & 37 \\
dart\_base (T4F) & definitive\_v3 & không (oracle tầng) & +0,1902 & +0,1819 & 70,3\% & +0,5548 & 37 \\
oracle\_real\_bm & irm\_invariant & không (oracle tb) & +0,2429 & +0,1850 & 85,0\% & +0,6031 & 40 \\
sgm\_real\_bm & irm\_invariant & không (oracle tb) & +0,2701 & +0,2377 & 92,5\% & +0,6038 & 40 \\
oracle\_bm & satellite\_v5g & không (oracle tb, trần) & +0,3063 & +0,2910 & 91,9\% & +0,5694 & 37 \\
\bottomrule
\end{longtable}
}


Khoảng cách giữa dải triển khai được và ngưỡng trần oracle là chi phí thông tin của việc không biết trung bình trạm, và nó lớn. Được đo trên các fold tương ứng trong một tệp duy nhất --- cách duy nhất sạch về phương pháp luận để lấy hiệu số hai, vì các cấu hình chia sẻ một tập trạm ở đó --- biên cơ sở oracle vượt mô hình cluster-base-margin triển khai được tốt nhất +0,277 về R\textsuperscript{2} trung bình theo trạm, +0,272 về trung vị, và +37,8 điểm phần trăm về tỷ lệ trạm dương. Cùng so sánh trong tệp invariant, lấy hiệu số cấu hình oracle trung-bình-thực so với đường cơ sở không-phân-nhóm triển khai được, cho +0,332 về trung bình, +0,224 về trung vị, và +40,0 điểm phần trăm dương. Theo cách làm tròn, việc biết trung bình thực của mỗi trạm trị giá khoảng +0,28 đến +0,33 về R\textsuperscript{2} trung bình theo trạm và khoảng bốn mươi điểm phần trăm trạm dùng được bổ sung.

{\small
\begin{longtable}{lllll}
\caption{Chi phí thông tin của việc không biết trung bình trạm --- các khoảng cách oracle-trừ-triển-khai về R\textsuperscript{2} trung bình, R\textsuperscript{2} trung vị, và tỷ lệ dương, được đo trên các tập trạm tương ứng.}\\
\toprule
\textbf{Khoảng cách (oracle $-$ triển khai)} & \textbf{Tập tương ứng} & \textbf{KC trung bình R\textsuperscript{2}} & \textbf{KC trung vị R\textsuperscript{2}} & \textbf{KC \% > 0} \\
\midrule\endhead
oracle\_bm vs clust\_bm\_rfsi & satellite\_v5g, 37 trạm & +0,2771 & +0,2721 & +37,8 điểm \\
sgm\_real\_bm vs no\_t4f & irm\_invariant, 40 trạm & +0,3316 & +0,2235 & +40,0 điểm \\
\bottomrule
\end{longtable}
}


Toàn bộ chuỗi ba-con-số của luận văn giờ đã hiện ra. Mô hình đạt R\textsuperscript{2} $\approx$ 0,81 dưới đánh giá chéo ngẫu nhiên, R\textsuperscript{2} $\approx$ 0,20 dưới LOSO true-tier trung thực, và một R\textsuperscript{2} trung vị theo trạm triển khai được $\approx$ 0,04 một khi tầng oracle bị rút đi. Bước thứ nhất, từ 0,81 xuống 0,20, là chi phí của việc chuyển từ nội suy thời gian sang ngoại suy không gian (Mục 5.3); bước thứ hai, từ 0,20 xuống 0,04, là chi phí của phụ thuộc vòng tròn --- khoảng cách giữa việc biết và không biết chế độ ô nhiễm của mỗi trạm. Khoảng cách triển-khai-đến-oracle khoảng +0,27 trung bình theo trạm là cái giá chính xác của thông tin bị thiếu đó, và sự hội tụ của ba hướng tiếp cận triển khai được độc lập ở đáy của nó là bằng chứng mạnh rằng khoảng +0,04 trung vị là ngưỡng trần triển khai thực sự chỉ từ các biến quan sát được từ vệ tinh, khi không có dữ liệu hiệu chuẩn cục bộ. Đáng chú ý là ngay cả các mô hình triển khai được cũng hoạt động tốt hơn nhiều tại tầng ô nhiễm t3 (trung bình t3 từ +0,24 đến +0,42) so với tổng thể, phản chiếu gradient tầng của Mục 5.4; các trung vị tổng thể gần-không bị kéo xuống bởi các trạm tầng-thấp sạch, không phải bởi thất bại đồng đều ở khắp nơi.

Tuy nhiên, ngưỡng trần +0,04 đó cụ thể là ngưỡng trần cho việc phục hồi đường cơ sở trạm \emph{từ các biến quan sát được từ vệ tinh}. Nó không phải ngưỡng trần cho một mô hình được phép nội suy đường cơ sở từ mạng lưới quan trắc xung quanh. Quy trình định tuyến tiên nghiệm không gian của Mục 3.6.4 làm chính xác điều đó, và nó thay đổi bức tranh một cách đáng kể. Thay vì ước tính tầng từ các biến quan sát được --- chiến lược tạo ra dải +0,04 và thất bại với bảy họ của Mục 5.7 --- nó ước tính mức nền của mỗi trạm giữ lại như một trung bình có trọng số khoảng cách của các trung bình \emph{quan trắc} của các trạm huấn luyện xung quanh (bản thân trạm luôn bị loại trừ), rồi dịch chuyển và định tuyến các luồng dự đoán không-mục-tiêu về phía ước tính đó. Được đánh giá dưới cùng giao thức bỏ-một-trạm-ra trên bốn mươi trạm, với GHAP được loại bỏ nên kết quả không phụ thuộc vào sản phẩm PM2.5 khí hậu nào, quy trình triển khai được này đạt R\textsuperscript{2} trung bình theo trạm 0,197 và trung vị 0,117 --- trong vòng 0,01 và 0,03 của ngưỡng trần T4F oracle 0,203 và 0,147 --- với R\textsuperscript{2} gộp 0,569 so với 0,572 của oracle, ba mươi trong bốn mươi trạm dương, và, quan trọng là, không có chuyển trạng thái lớp cao-thành-không-cao và không có chuyển trạng thái thấp-thành-cao nguy hiểm nào, an toàn hơn một cách cận biên so với chính oracle. Tóm lại, một mô hình hoàn toàn triển khai được phục hồi gần như toàn bộ mức tăng tầng oracle mà các đại diện quan sát được từ vệ tinh không thể.

{\small
\begin{longtable}{lllllll}
\caption{Mô hình định tuyến tiên nghiệm không gian so với ngưỡng trần oracle và dải triển khai dựa-trên-biến-quan-sát-từ-vệ-tinh, tất cả dưới bỏ-một-trạm-ra không-GHAP. Bộ ước tính đường-cơ-sở-không-gian triển khai được khép gần như toàn bộ khoảng cách oracle mà ước tính tầng từ biến quan sát không thể.}\\
\toprule
\textbf{Cấu hình} & \textbf{Triển khai} & \textbf{R\textsuperscript{2} gộp} & \textbf{R\textsuperscript{2} tb trạm} & \textbf{R\textsuperscript{2} trung vị trạm} & \textbf{Cao$\rightarrow$không-cao} & \textbf{Nguy hiểm thấp$\rightarrow$cao} \\
\midrule\endhead
oracle\_t4f (tầng thực, trần) & không & 0,572 & 0,203 & 0,147 & 1 & 0 \\
chuyên gia MoE theo tầng (ý tưởng đúng nghĩa) & có & 0,434 & 0,083 & 0,081 & 6 & 1 \\
dải biến-quan-sát-từ-vệ-tinh (§3.6.1--3.6.3) & có & --- & $\approx$ +0,00 đến +0,04 & $\approx$ +0,01 đến +0,04 & --- & --- \\
\textbf{định tuyến tiên nghiệm không gian (§3.6.4, triển khai)} & \textbf{có} & \textbf{0,569} & \textbf{0,197} & \textbf{0,117} & \textbf{0} & \textbf{0} \\
\bottomrule
\end{longtable}
}


Cơ chế của sự khác biệt đáng được nêu chính xác, bởi vì nó dễ bị đọc nhầm như một mâu thuẫn với ngưỡng trần +0,04 nhưng thực ra không phải. Các cấu hình triển khai được của dải ở trên đã sử dụng các đặc trưng trạm-lân-cận không gian (RFSI): sự khác biệt không phải là mô hình mới có quyền truy cập các trạm lân cận và các mô hình khác thì không. Sự khác biệt là \emph{thông tin trạm lân cận được dùng để làm gì}. Các cấu hình trước đó dùng các trạm lân cận như các đặc trưng đồng-biến-thiên theo giờ, vốn cố định \emph{hình dạng} thời gian của chuỗi nhưng để \emph{mức đường cơ sở} tuyệt đối không được neo --- thất bại kinh điển trong đó chuỗi dự đoán của một trạm giữ lại có mẫu đúng nhưng trung bình sai. Tiên nghiệm không gian dùng các trạm lân cận để neo mức đường cơ sở đó trực tiếp, như một vật thay thế triển khai được cho biên cơ sở oracle, cung cấp đại lượng duy nhất mà các biến quan sát được từ vệ tinh không thể. Thiết kế hai-pha trước đó (Mục 3.6.2) đã thử cùng việc neo nhưng ước tính trung bình từ các đặc trưng vệ tinh (R\textsuperscript{2} bỏ-một-ra $\approx$ 0,59) và tiêm nó như một biên cơ sở cứng, vốn vượt quá tại các vị trí sạch; ước tính không gian vừa chính xác hơn vừa được dùng thận trọng hơn, đó là lý do nó thành công ở nơi thiết kế hai-pha thất bại. Lưu ý thiết yếu theo sau từ cơ chế: bởi vì ước tính là một nội suy không gian, kỹ năng của nó phụ thuộc vào sự gần kề của các trạm nội suy, và nó suy giảm khi mục tiêu di chuyển ra xa mạng lưới --- chính là ràng buộc mật độ của Chương 4 được nêu lại, và được kiểm tra trực tiếp trên các trạm chưa thấy ở Mục 5.6.


\section{Đánh giá độc lập (mạng lưới LCS)}
...
Chi tiết cấp-vị-trí làm cho sự phụ thuộc mật độ cụ thể. Các vị trí chi phí thấp tốt nhất được dự đoán gần tốt bằng Đại sứ quán, với các giá trị R\textsuperscript{2} từ 0,65 đến 0,76, và chúng hầu hết đều gần một trạm neo quan trắc --- trong vòng vài kilômét ở trung tâm Hà Nội hoặc ở các thị trấn đồng bằng liền kề. Các vị trí tệ nhất được dự đoán thảm họa, với các giá trị R\textsuperscript{2} từ -0,16 đến -14,75, và chúng chủ yếu ở xa bất kỳ trạm neo nào, ở Hải Phòng và các vị trí Hưng Yên ngoại vi cách trạm quan trắc gần nhất 15 đến 43 km.

{\small
\begin{longtable}{llllll}
\caption{Mười vị trí chi phí thấp được dự đoán tốt nhất theo R\textsuperscript{2}, với khoảng cách đến trạm quan trắc gần nhất, độ dài bản ghi, và RMSE.}\\
\toprule
\textbf{Hạng} & \textbf{R\textsuperscript{2}} & \textbf{KC KK (km)} & \textbf{n giờ} & \textbf{RMSE} & \textbf{Trạm} \\
\midrule\endhead
...
{\small
\begin{longtable}{lllll}
\caption{Các vị trí chi phí thấp được dự đoán kém nhất, tất cả đều ở xa bất kỳ trạm neo quan trắc nào, với khoảng cách, độ dài bản ghi, và RMSE.}\\
\toprule
\textbf{R\textsuperscript{2}} & \textbf{KC KK (km)} & \textbf{n giờ} & \textbf{RMSE} & \textbf{Trạm} \\
\midrule\endhead
...
\section{Tổng hợp các thí nghiệm không thành công}
...
Bài học của bảy thất bại này nhất quán và, theo cách của nó, giàu thông tin hơn một thành công. Nhãn tầng mã hóa mức ô nhiễm trung bình của trạm, và trung bình đó chính xác là đại lượng không thể quan sát được tại một vị trí không có quan trắc mà không có phép đo mặt đất. Mọi nỗ lực phục hồi nó từ các biến quan sát được --- bằng cách làm mềm nó, phân cụm về phía nó, dự đoán nó, loại bỏ sự phụ thuộc vào nó, hoặc né tránh nó qua các dị thường --- hoặc chỉ tái tạo một phần của tín hiệu hoặc phá hủy nó hoàn toàn. Do đó các thí nghiệm không chỉ thất bại; chúng tam giác đạc ranh giới của điều gì có thể đạt được, và chúng xác lập rằng trung vị +0,04 triển khai được là một ngưỡng trần thông tin thực sự \emph{cho ước tính dựa-trên-biến-quan-sát-từ-vệ-tinh về đường cơ sở}, không phải một sự thiếu sót về nỗ lực. Phụ thuộc vòng tròn là thực và ràng buộc đối với lớp phương pháp đó: không có đại diện quan sát được từ vệ tinh nào được kiểm tra trong luận văn này phục hồi được trung bình bị thiếu.

Tuy nhiên, ranh giới mà bảy thất bại này tam giác đạc cụ thể là ranh giới của ước tính \emph{quan sát được}, và việc định vị nó chính xác chỉ ra nơi thông tin bị thiếu thực sự nằm. Mức ô nhiễm trung bình không thể được đọc ra từ các biến quan sát được từ vệ tinh hay sử dụng đất --- nhưng nó có thể được nội suy từ mạng lưới quan trắc xung quanh, bởi vì đường cơ sở của một trạm được dự đoán mạnh bởi các đường cơ sở quan trắc của các trạm lân cận của nó. Đây là đòn bẩy mà bảy họ chưa bao giờ kéo: mỗi họ trong số chúng, bao gồm bộ dự đoán hai-pha và các sơ đồ phân cụm, tìm tầng trong không gian đặc trưng quan sát được, trong khi lời giải nằm trong không gian vật lý. Quy trình định tuyến tiên nghiệm không gian của Mục 3.6.4 và 5.5 quả thực kéo nó, phục hồi một trung bình theo trạm 0,197 so với 0,203 của oracle bằng cách neo đường cơ sở vào các trạm quan trắc lân cận thay vì đoán nó từ vệ tinh. Điều này không làm yếu bảy kết quả âm --- nó làm sắc nét diễn giải của chúng. Phụ thuộc vòng tròn không thể phá vỡ từ riêng các biến quan sát được, và có thể phá vỡ bằng nội suy không gian từ mạng lưới; cái giá của lời giải là nó kế thừa tầm với của mạng lưới, hoạt động ở nơi mục tiêu có các trạm lân cận khả dụng và suy giảm ở nơi không có. Do đó ngưỡng trần triển khai không phải một con số duy nhất mà là một hàm của sự gần kề trạm, và ràng buộc then chốt, một lần nữa, là mật độ của mạng lưới mặt đất chứ không phải thuật toán.


\section{Một góc nhìn thống nhất: nội suy và ngoại suy}

Các mục trước đã đánh giá mô hình dưới nhiều khung đánh giá --- từ kỳ vọng ban đầu (đánh giá chéo ngẫu nhiên) đến bài toán trọng tâm (LOSO) và đánh giá độc lập --- mà cho đến nay được xử lý như những khung riêng biệt. Đọc cùng nhau, chúng phân giải thành một nguyên lý tổ chức duy nhất giải thích vì sao các con số nổi bật biến thiên rộng đến vậy --- từ trên 0,8 đến dưới 0,1 --- cho cái về danh nghĩa là một mô hình trên một bộ dữ liệu. Mọi dự đoán mà mô hình có thể được yêu cầu thực hiện hoặc là một \emph{nội suy} giữa các quan trắc đã biết hoặc là một \emph{ngoại suy} đến một điểm thực sự chưa được quan trắc, và kỹ năng có thể đạt được được chi phối gần như hoàn toàn bởi việc một bài toán cho trước đòi hỏi cái nào trong hai. Các con số cao trong tài liệu khoa học, và trong luận văn này, là nội suy; mục tiêu vận hành --- một bản đồ ô nhiễm cho các vị trí không có quan trắc --- là ngoại suy; và việc gộp lẫn hai cái là chính xác sự nhầm lẫn mà Mục 2.1 đã phân biệt.

Trước tiên hữu ích là tách hai bài toán mà thuật ngữ "dự đoán thời gian" lặng lẽ gộp lại, bởi vì chúng nằm ở hai phía đối lập của ranh giới nội-suy--ngoại-suy. Thứ nhất là \emph{lấp khoảng trống thời gian}: bù các giờ thiếu tại một trạm có lịch sử đo đạc, trường hợp vận hành của cảm biến ngừng hoạt động hoặc khoảng trống bảo trì. Thứ hai là \emph{dự báo thời gian}: dự đoán các giờ nằm trong tương lai, ngoài cuối bản ghi huấn luyện. Để đo từng cái một cách sạch sẽ, mô hình được huấn luyện lại theo từng trạm chỉ dùng các đặc trưng ngoại sinh (khí tượng, quan trắc vệ tinh, và các mã hóa thời gian --- không có lịch sử PM), một lần dưới một phép chia năm-fold ngẫu nhiên trên các giờ riêng của trạm (lấp khoảng trống) và một lần dưới một phép chia theo trình tự thời gian huấn luyện trên 70\% đầu của bản ghi và dự đoán 30\% cuối (dự báo). Sự tương phản là quyết định và được báo cáo trong Bảng 5.21.

{\small
\begin{longtable}{lllll}
\caption{Cùng một mô hình đặc-trưng-ngoại-sinh theo trạm được đánh giá như bốn bài toán khác nhau, theo tầng ô nhiễm. Lấp khoảng trống và dự báo dùng dữ liệu riêng của trạm trong huấn luyện; bản đồ không gian (LOSO) thì không. Dự báo được phân tách thành R\textsuperscript{2} thô và kỹ năng hình dạng (bình phương tương quan Pearson của chuỗi tương lai dự đoán và quan trắc).}\\
\toprule
\textbf{Tầng} & \textbf{Lấp khoảng trống (R\textsuperscript{2} KFold trong-trạm)} & \textbf{Dự báo --- R\textsuperscript{2} thô (trung vị)} & \textbf{Dự báo --- r\textsuperscript{2} hình dạng (trung vị)} & \textbf{Bản đồ không gian (R\textsuperscript{2} LOSO)} \\
\midrule\endhead
