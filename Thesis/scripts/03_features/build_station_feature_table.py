"""Build a clean station summary table from the final merged data.

This helper is intentionally narrow: it only computes station-level PM2.5
summaries and coordinates after the shared QC mask. It is suitable for
simple geography/anchor diagnostics. It must not preserve old model-prediction
or diagnostic columns, because those columns are not deployable descriptors of a
new target station.
"""
