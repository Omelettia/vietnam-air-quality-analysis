...
def apply_pm25_quality_mask(
    ...
    **kwargs,
    ...
    """Return a copy of *df* with invalid PM2.5 set to NaN plus row masks."""
    masks = pm25_quality_masks(
        df,
    ...
    out = df.copy()
    out.loc[masks.any(axis=1), value_col] = np.nan
    return out, masks
