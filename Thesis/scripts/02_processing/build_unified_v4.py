"""
Build unified_thesis_v4.csv — definitive dataset for all stations.

Changes from v3:
  - No station-level exclusions (BROKEN_REMOVE / DROP_BAD_SENSOR removed)
  - Row-level QC via pm25_quality_masks (flatline, stuck-low, range checks)
  - Proper station_type label (LCS vs KK)
  - Relaxed PM2.5 coverage threshold (10% instead of 30%)
...
Usage: python Thesis/scripts/02_processing/build_unified_v4.py
"""
...
OUT_PATH = "data/merged/unified_thesis_v4.csv"
...
# Merge log
log_path = "analysis/thesis_audit/merge_log_v4.csv"
