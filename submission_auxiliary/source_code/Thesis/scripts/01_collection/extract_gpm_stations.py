...
Output:
  - Per-station CSVs: data/gpm/station_gis_extracted/{stationId}.csv
    Columns: stationId, datetime, precipitationCal, precipitationUncal,
             IRprecipitation, MWprecipitation, randomError, ...

Usage:
  python extract_gpm_stations.py [--input data/gpm/raw] [--output data/gpm/station_gis_extracted]
...
def main():
    ...
    parser.add_argument("--output", default="data/gpm/station_gis_extracted",
